...
<head>
    ...
    <style>
        ...
        /* Modifikasi agar input password tidak kaku di sisi kanan saat ada tombol mata */
        ...
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="username" class="form-control" placeholder="••••••••" value="{{ old('username') }}" autocomplete="username" required>
                </div>
            </div>
