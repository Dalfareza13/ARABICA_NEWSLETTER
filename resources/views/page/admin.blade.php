...
<head>
    ...
    <style>
        ...
        .sidebar { 
            ...
            z-index: 1050; /* Di atas backdrop bootstrap */
        }
        ...
        @media (max-width: 767.98px) {
            ...
            .btn-publish { width: 100%; border-radius: 10px !important; }
        }
        ...
        .btn-publish { background-color: var(--pln-dark); color: white; transition: 0.3s; border: none; }
        .btn-publish:hover { background-color: #001a35; transform: translateY(-2px); }
